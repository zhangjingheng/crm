...
<BODY BGCOLOR=#FFFFFF LEFTMARGIN=0 TOPMARGIN=0 MARGINWIDTH=0
	...
	<form action="${ctp}/user/login" method="post">
		...
		<TABLE WIDTH=800 BORDER=0 CELLPADDING=0 CELLSPACING=0>
			...
			<TR>
				<TD COLSPAN=7><IMG SRC="${ctp}/static/images/login/login_03.jpg"
			...
			<TR>
				...
				<TD ROWSPAN=4>&nbsp;</TD>
				<TD COLSPAN=2><IMG SRC="${ctp}/static/images/login/login_08.jpg"
					WIDTH=94 HEIGHT=39 ALT=""></TD>
				<TD><IMG SRC="${ctp}/static/images/login/spacer.gif" WIDTH=1
					HEIGHT=39 ALT=""></TD>
			</TR>
			<TR>
				<TD ROWSPAN=3><IMG SRC="${ctp}/static/images/login/login_09.jpg"
					WIDTH=15 HEIGHT=141 ALT=""></TD>
				...
				<TD COLSPAN=2><IMG SRC="${ctp}/static/images/login/login_11.jpg"
					WIDTH=304 HEIGHT=86 ALT=""></TD>
				<TD><IMG SRC="${ctp}/static/images/login/spacer.gif" WIDTH=1
					HEIGHT=86 ALT=""></TD>
			</TR>
			<TR>
				<TD ROWSPAN=2><IMG SRC="${ctp}/static/images/login/login_12.jpg"
					WIDTH=19 HEIGHT=55 ALT=""></TD>
			...
			<TR>
				<TD COLSPAN=2><IMG SRC="${ctp}/static/images/login/login_14.jpg"
